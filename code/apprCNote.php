    ...
    <body>
        <?php
            ...
            if(strcmp($utype,"EMPLOYEE")==0)
                include("empNav.html");
            else if(strcmp($utype,"ADMIN")==0 || strcmp($utype,"CUSTOMER")==0)
                header("location:accessDenied.php");
        ?>

        <h2><br /><center>View Pending Credit Notes</center><br /></h2>
                    ...
                    <tbody>
                        <?php
                            ...
                            $query = "SELECT C.CR_ID,U.UFNAME,U.ULNAME,C.CRCREATED_DATE,C.CR_AMOUNT,C.CR_STATUS FROM CREDIT_NOTES C INNER JOIN
                                          USERS U ON C.CUST_ID=U.USER_ID WHERE U.UTYPE='CUSTOMER' AND C.CR_STATUS='PENDING'";
                            ...
                            while (oci_fetch($result)) {
                                echo "<tr><td><input type='radio' class='creditnote' name='cr' value='" . $crid . "'></td>";
